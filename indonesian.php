...
if (!defined("WHMCS")) die("File ini tidak dapat diakses secara langsung");

$_LANG['locale'] = "id";

$_LANG['accountinfo'] = "Informasi Akun";
$_LANG['accountstats'] = "Statistik Akun";
$_LANG['addfunds'] = "Tambahkan Saldo";
